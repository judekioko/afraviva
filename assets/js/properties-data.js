...
const AFRAVIVA_PROPERTIES = [
  ...
  },
  {
    ...
    gallery: [
      { src: "assets/img/sensei exterior beachfront.jpeg", caption: "Artist's impression — beachfront exterior at sunset" },
      { src: "assets/img/sensei aerial pool beach.jpeg", caption: "Artist's impression — aerial view, pool & beach" },
      { src: "assets/img/sensei pool night.jpeg", caption: "Artist's impression — pool at night" },
      { src: "assets/img/sensei pool terrace evening.jpeg", caption: "Artist's impression — pool terrace, evening" },
      { src: "assets/img/sensei courtyard dusk.jpeg", caption: "Artist's impression — landscaped courtyard at dusk" },
      { src: "assets/img/sensei courtyard render.jpeg", caption: "Artist's impression — courtyard, evening" },
      { src: "assets/img/sensei garden walk to beach.jpeg", caption: "Artist's impression — garden walk to the beach" },
      { src: "assets/img/sensei terrace ocean view.jpeg", caption: "Artist's impression — private terrace, ocean view" },
      { src: "assets/img/sensei duplex living room.jpeg", caption: "Artist's impression — duplex living room" },
      { src: "assets/img/sensei living room lounge.jpeg", caption: "Artist's impression — double-height living room" },
      { src: "assets/img/sensei dining kitchen.jpeg", caption: "Artist's impression — dining & kitchen" },
      { src: "assets/img/sensei bedroom ocean view.jpeg", caption: "Artist's impression — bedroom, ocean view" },
      { src: "assets/img/sensei bedroom suite.jpeg", caption: "Artist's impression — bedroom suite, balcony view" },
      { src: "assets/img/sensei workspace nook.jpeg", caption: "Artist's impression — workspace nook" },
    ...
    artVariant: "coast",
    videos: [
      { src: "assets/video/sensei.mp4", portrait: true }
    ],
    nearby: {
      dining: [
