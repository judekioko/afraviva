...
const SITE_HEADER_HTML = `<header class="site-header">
  <div class="wrap nav">
    <a href="index.html" class="brand">
      <img class="mark" src="assets/img/afraviva-logo.png" alt="">
      <span class="brand-name">Afra<span class="v-flag">V</span>iva Homes</span>
    </a>
    <nav class="nav-links">
      <a href="https://afraviva.com" class="nav-back">&larr; AfraViva.com</a>
    ...
    <div class="footer-grid">
      <div>
        <div class="footer-brand">
          <img class="mark" src="assets/img/afraviva-logo.png" alt="" width="26" height="26">
          <span class="brand-name">Afra<span class="v-flag">V</span>iva Homes</span>
        </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="https://afraviva.com">&larr; AfraViva.com</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Properties</h4>
